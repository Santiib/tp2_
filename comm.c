...
//Imprime todas las lineas que contiene el hash dado.
...
//Si modo == 0: imprime las lineas en comun entre ambos archivos.
//Si modo == 1: imprime las lineas unicas del archivo 1.
//Si modo == 2: imprime las lineas unicas del archivo 2.
...
//Verifica que modo fue elegido. Devuelve -1 si el modo es invalido.
